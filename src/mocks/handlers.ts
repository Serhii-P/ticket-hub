...
import { CreateOrderRequestDto } from "../api/dto/CreateOrderRequest";
...
export const handlers = [
        ...
        dates: [
          {
            id: 3,
            name: "Dia 3",
            date: "2018-02-25T20:46:43Z",
          },
          {
            id: 2,
            name: "Dia 2",
            date: "2018-03-26T20:46:43Z",
          },
          {
            id: 1,
            name: "Dia 1",
  ...
  rest.post("/api/order", async (req, res, ctx) => {
    const body: CreateOrderRequestDto = await req.json<CreateOrderRequestDto>();
